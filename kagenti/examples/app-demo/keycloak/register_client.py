...
def main():
    ...
    client_payload = {
        "clientId": client_id,
        "name": "Kagenti App Demo",
        "description": "Demo application showing Kagenti platform integration",
        "rootUrl": root_url,
        "enabled": True,
        "publicClient": True,
    ...
    try:
        ...
        logger.info("Created 'kagenti-operator' realm role")
    except KeycloakPostError:
        logger.info("'kagenti-operator' realm role already exists")

...
import (
	...
	kagentiv1alpha1 "github.com/kagenti/kagenti/platform-operator/api/v1alpha1"
	"github.com/kagenti/kagenti/platform-operator/internal/components"
	"github.com/kagenti/kagenti/platform-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dc2b52e0.kagenti.dev",
	...
	// Build the component registry (reconciled in this order)
	...
	if err = (&controller.KagentiPlatformReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "KagentiPlatform")
		os.Exit(1)
	}
